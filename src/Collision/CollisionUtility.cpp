...
bool CollisionUtility::FindCollision(const RectangleCollider& rectangle, const CircleCollider& circle)
{
	...
	const float relativeDistance = std::sqrt(std::powf(circle.Position.x - recSurfacePoint.x, 2)
		+ std::powf(circle.Position.y - recSurfacePoint.y, 2));

	return relativeDistance <= circle.Radius;
...
bool CollisionUtility::FindCollision(const RectangleCollider& rectangle1, const RectangleCollider& rectangle2)
{
...
bool CollisionUtility::FindCollision(const CircleCollider& sphere1, const CircleCollider& sphere2)
{
