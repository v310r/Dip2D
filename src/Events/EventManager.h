...
public:
	...
	glm::vec2 GetMousePos(sf::RenderWindow* window = nullptr)
	{
		return window ? glm::vec2{ sf::Mouse::getPosition(*window).x, sf::Mouse::getPosition(*window).y }
					  : glm::vec2{ sf::Mouse::getPosition().x, sf::Mouse::getPosition().y };
	}
